...
class YeMaControllerTest : public ::testing::Test {
 public:
  virtual void SetUp() {
...
TEST_F(YeMaControllerTest, Status) {
  controller_.Init(params_, &sender_, &msg_manager_);
...
TEST_F(YeMaControllerTest, UpdateDrivingMode) {
  controller_.Init(params_, &sender_, &msg_manager_);
  controller_.set_driving_mode(Chassis::COMPLETE_AUTO_DRIVE);
